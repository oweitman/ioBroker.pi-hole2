...
module.exports = class PiholeClient {
     ...
     * @param {object} [options.adapter] - iobroker Adapter object.
     */
    constructor(options) {
    ...
    async makeRequest(method, path, body = null, query = null) {
        ...
        const timeout = this.adapter?.setTimeout
            ? this.adapter.setTimeout(() => controller.abort(), this.options.timeout ?? 10000)
            : setTimeout(() => controller.abort(), this.options.timeout ?? 10000);
        ...
        try {
            ...
            this.adapter?.clearTimeout ? this.adapter.clearTimeout(timeout) : clearTimeout(timeout);
        }
    }
