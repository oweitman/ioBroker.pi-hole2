...
class piholeserverclass {
    ...
    /**
     * Checks if the datapoints in stateTemplateDetailedVersion exist. If they don't, they are created.
     * The values are also stored in the this.data array for later use.
     * Updates the color of the datapoints based on the enabledetailedversion config setting.
     */
     ...
     *
     * @returns {Promise<boolean>} The current connection status.
     */
