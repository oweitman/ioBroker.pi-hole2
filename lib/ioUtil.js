...
class ioUtil {
     ...
     *
     * @param {string} id - The name of the state to retrieve.
     * @param {string|false|null|undefined} [level1path] - The first level path to prepend to the state name.
     * @param {string|false|null|undefined} [level2path] - The second level path to prepend to the state name.
     * @param {object} callback - The callback function to call when the state is retrieved.
     */
